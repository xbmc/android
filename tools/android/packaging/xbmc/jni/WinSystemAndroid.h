...
class CDirtyRegionList;

typedef struct fbdev_window fbdev_window;

#include <android_native_app_glue.h>

class CWinSystemAndroid //: public CWinSystemBase, public CRenderSystemGLES
{
public:
  CWinSystemAndroid();
  virtual ~CWinSystemAndroid();

  virtual bool  InitWindowSystem( android_app *androidApp );
  ...
  virtual void SwapBuffers() { m_eglBinding->SwapBuffers(); }
...
protected:
  ...
  CWinBindingAndroid    *m_eglBinding;
  int                    m_fb_width;
  int                    m_fb_height;
  int                    m_fb_bpp;
