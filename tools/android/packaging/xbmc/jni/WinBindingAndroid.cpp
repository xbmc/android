...
CWinBindingAndroid::CWinBindingAndroid()
{
...
bool CWinBindingAndroid::ReleaseSurface()
{
...
bool CWinBindingAndroid::CreateWindow(EGLNativeDisplayType nativeDisplay, EGLNativeWindowType nativeWindow)
{
  EGLBoolean eglStatus;
  EGLint     configCount;
...
#if 0
  // This needs to be done in the GLES backend!
...
bool CWinBindingAndroid::DestroyWindow()
{
  EGLBoolean eglStatus;
  if (m_context != EGL_NO_CONTEXT)
  {
...
void CWinBindingAndroid::SwapBuffers()
{
  eglSwapBuffers(m_display, m_surface);
}

bool CWinBindingAndroid::SetVSync(bool enable)
{
...
bool CWinBindingAndroid::IsExtSupported(const char* extension)
{
  CStdString name;
...
EGLNativeWindowType CWinBindingAndroid::GetNativeWindow()
{
  return m_nativeWindow;
}

EGLNativeDisplayType CWinBindingAndroid::GetNativeDisplay()
{
  return m_nativeDisplay;
}

EGLDisplay CWinBindingAndroid::GetDisplay()
{
  return m_display;
}

EGLSurface CWinBindingAndroid::GetSurface()
{
  return m_surface;
}

EGLContext CWinBindingAndroid::GetContext()
{
  return m_context;
}
